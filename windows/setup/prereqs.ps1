...
# Opt-in for file paths longer than 260 characters
...
##########################################################################
# Windows N - Media Feature Pack
# This is only necessary on Windows N so Firefox can use OpenH264 and
# render things like Twitch and YouTube live streams
##########################################################################
...
powercfg /change monitor-timeout-ac 10 # Turn off monitor after 10 minutes
